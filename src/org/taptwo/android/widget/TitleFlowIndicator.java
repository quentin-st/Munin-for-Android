...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int textColor = a.getColor(R.styleable.TitleFlowIndicator_textColor2, TEXT_COLOR);
		float textSize = a.getDimension(R.styleable.TitleFlowIndicator_textSize2, TEXT_SIZE);
