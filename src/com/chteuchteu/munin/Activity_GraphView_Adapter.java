...
public class Activity_GraphView_Adapter extends BaseAdapter implements TitleProvider {
	private MuninFoo		muninFoo;
	
	private LayoutInflater	mInflater;
	private int 			position;
	
	public Activity_GraphView_Adapter(Context context) {
	...
	public int getCount() {
		...
		if (muninFoo == null)
			muninFoo = MuninFoo.getInstance();
		return muninFoo.currentServer.getNbPlugins();
	}
	...
	public String getTitle(int position) {
		if (position >= 0 && position < muninFoo.currentServer.getNbPlugins())
