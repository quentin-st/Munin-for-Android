...
public class Database extends SQLiteOpenHelper {
    ...
    private HashMap<Class<?>, BaseRepository> repositories;
    ...
    public Database (Context c) {
        ...
        this.repositories.put(MuninMaster.class, new MuninMasterRepository(this));
        this.repositories.put(MuninNode.class, new MuninNodeRepository(this));
        this.repositories.put(MuninPlugin.class, new MuninPluginRepository(this));
        this.repositories.put(Label.class, new LabelRepository(this));
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(MuninMasterRepository.CREATE_TABLE);
        db.execSQL(MuninNodeRepository.CREATE_TABLE);
        db.execSQL(MuninPluginRepository.CREATE_TABLE);
        db.execSQL(LabelRepository.CREATE_TABLE);
    ...
    public BaseRepository getRepository(Class<?> className) {
